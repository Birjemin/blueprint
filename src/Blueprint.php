...
class Blueprint
{
    ...
    {
        $this->reader->addNamespace('Birjemin\\Blueprint\\Annotation');
        $this->reader->addNamespace('Birjemin\\Blueprint\\Annotation\\Method');

        AnnotationRegistry::registerLoader(function ($class) {
            $path = __DIR__.'/'.str_replace(['Birjemin\\Blueprint\\', '\\'], ['', DIRECTORY_SEPARATOR], $class).'.php';
